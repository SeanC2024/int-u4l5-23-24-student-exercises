...
let secretUsername = ("SEANdis");
let secretPassword = ("I love ye");
...
button.addEventListener("click", function() {
    ...
    if (username === secretUsername && password === secretPassword){
        message.innerHTML = "Good job pookie ;D";
    }
    // CODE SOLO
    ...
    //  - Finally, if the password is incorrect AND the username is incorrect, update the text of the message div to say "Incorrect username and password. Hmm. Suspicious."
        ...
        message.innerHTML = "password wrong dumbass";
    }
    else if (username !== secretUsername && password === secretPassword){
        message.innerHTML = "username wrong stupid";
    }
    else if (username !== secretUsername && password !== secretPassword){
        message.innerHTML = "username and password wrong you should die";
    }
    else {
        message.innerHTML = "Try aggain!!!!!!";
    }
